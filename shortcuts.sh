...
alias sjs-build-and-flash-latest-2='pushd ~/iot-src/smart.js/smartjs/platforms/esp8266; make; /Applications/FNC.app/Contents/MacOS/FNC --flash-baud-rate 115200 --flash firmware/smartjs-esp8266-last.zip --platform esp8266 --port /dev/cu.wchusbserial1420; popd'
